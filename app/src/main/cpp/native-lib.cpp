...
#include "includes/opencv2/imgproc/types_c.h"

using namespace cv;
extern "C" JNIEXPORT jstring

Java_com_opencvtut_opencvnativeapplication_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
// This extern block defines methods that will be called into by Unity
extern "C" {
